...
def compute_PR_RR(Agreement_list, input_signal_1, input_signal_2, fs_1, fs_2, show=False):
    ...
    # Reference: Recognizing Emotions Induced by Affective Sounds through Heart Rate Variability. TAC. 2015
    # 提到使用三次样条插值
    # Reference: Comparison of methods for removal of ectopy in measurement of heart rate variability
    ...
    # Reference: B. Mali et al., "Matlab-based tool for ECG and HRV analysis", Biomed. Signal Process. Control, vol. 10, pp. 108-116, 2014.
    # 4Hz resample
    fs = 4.0
    steps = 1 / fs
...
for dir_, task in zip(P_TO_CP, T_TO_CP):
    ...
    # compute_PR_RR(Agreement_list, ppg_signal, ppg_signal, 35, 35)
    compute_PR_RR(Agreement_list, ppg_signal, rppg_signal, 35, 35)

# Agreement Between Methods of Measurement with Multiple Observations Per Individual
# Bland-Altman
print("{:.4f}".format(np.average(Agreement_list) * 100))
# SciPy   Pulses  300ms
# rPPG    rPPG    92.7770
# PPG     PPG     92.3728
# rPPG    PPG     93.5566
